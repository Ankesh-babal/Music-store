...
GROUP BY
    c.customer_id,   c.first_name,  c.last_name,    bsa.artist_name, bsa.artist_id     
ORDER BY
    amount_spent DESC;
...
/* Steps to Solve:  Similar to the above question. There are two parts in question. First is  find the most spent on music for each country and second is filter the data for respective customers. */
